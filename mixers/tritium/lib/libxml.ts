...
# @abstract Removes everything else (including doctype) from the html
# @name keep_only_this
# @category Modify
# @scope XMLNode
# @args
...
"Inserts a script tag that links to the provided JS file in the current project. @example `add_javascript_asset(\"hello.js\")` will insert <script src='[$asset_host]/assets/javascript/hello.js'></script> at the bottom of the current node."
# @abstract Inserts an external script tag at the bottom of the current node.
# @name add_javascript_asset
# @category Create, Asset
# @scope XMLNode
# @args Text %filename
# @description
# @example
# add_javascript_asset("hello.js")
...
"Inserts a link tag that links to the provided stylesheet file in the current project. @example `add_sass_asset(\"main\")` will insert <link rel='stylesheet' href='[$asset_host]/assets/stylesheets/.css/main.css'></link> at the bottom of the current node."
# @abstract Inserts an external stylesheet link at the bottom of the current node.
# @name add_sass_asset
# @category Create, Asset
# @scope XMLNode
# @args Text %filename
...
"Inserts an img tag whose source is the provided image file in the current project. @example `add_image_asset(\"kitten.png\")` will insert <img src='[$asset_host]/assets/images/kitten.png'></img> at the bottom of the current node."
# @abstract Inserts an image tag at the bottom of the current node.
# @name add_image_asset
# @category Create, Asset
# @scope XMLNode
# @args Text %filename
# @description
# @example
# add_image_asset("kitten.png")
