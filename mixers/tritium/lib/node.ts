...
# }
# @exampletext Tritium Tester Example
# @examplelink test/examples/node/inject
# @guidetext 
# @guidelink 
...
# Native inject_at is broken but must be kept for older mixers.
# For new mixers, use the (hopefully) bug-free inject_at_v1
# @hide
