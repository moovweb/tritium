...
# 2011-09-15, Tarun Desikan
# Need to fix encoding issue on some browse pages (https://moov.lighthouseapp.com/projects/65328/tickets/182)
# This issue arises because the AJAX response is being guessed as UTF-8 even though it is sometimes ISO-8859-1
# Setting the charset seems to fix things; we *only* need to do this for the browse_ajax response
# This fix requires Manhattan 0.8.785+
log(concat("--> Setting Content-Type-Charset header to ", $encoding))
