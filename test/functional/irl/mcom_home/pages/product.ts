...
$("html/head"){
  ...
  $("(//*[@id = 'masterTableContainer'])[1]") {
    ...
    $("//div[@class='mvMasterItemWrapper']//div[@class='swatch-box']/div[@class='swatchBoxContainer']/img[contains(@src, 'swatches')]"){
      remove()
    }
  }
  ...
  # No need to wrap the contents at all
    ...
    $("//*[contains(concat(' ', @class, ' '), ' mvQuantityContainer ')]") {
      # Sometimes, there's an empty div which messed up the styling one level up..
      $("./../span[not(@class)]") {
  ...
  # No need to wrap the contents at all
    ...
    $("(//*[contains(concat(' ', @class, ' '), ' swatches ')]/div[position() = 7])[1]") {
      ...
      #Group::BasicGroup
        ...
        $("//*[@id = 'mvSwatchCarousel']") {
          match($done, "no") {
            ...
            attribute("data-ur-id","swatchCarousel")
          }
        }
      ...
      $("(//*[contains(concat(' ', @class, ' '), ' mvSwatchesWrapper ')])[1]") {
        inject_after("<div class=\"mvColorControl\"> <div class='total_count'></div>   <div class=\"mvSwatchesBtns\"> <a class=\"mvSwatchesPrevBtn mvDarkBtn\" data-ur-carousel-component='button' data-ur-carousel-button-type='prev'>&lt; back</a> <a class=\"mvSwatchesNextBtn mvDarkBtn\" data-ur-carousel-component='button' data-ur-carousel-button-type='next'>more &gt;</a> </div></div>") {
          $("//*[@class='total_count']") {
            text() {
              set("Available (")
              append($item_count)
  ...
  $("(//script[contains(@src, 'storeavail.js')])[1]") {
    attribute("src", asset('storeavail.js', 'js'))
    # adding these to the bundle
    #remove()
  }
  ...
  $("//div[@id = 'masterTableContainer']"){
   $(".//div[@class = 'tabContentContainer']/div[1]"){
     add_class("mvMasterDefault")
   }
    $(".//div[contains(@class, 'tabHolder')]") {
    $("./div"){
