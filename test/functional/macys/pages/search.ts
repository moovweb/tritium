...
html() {
  ...
  # No need to wrap the contents at all
    ...
    # No need to wrap the contents at all
      #
      #Content::Formatting::AddAttribute
      #[["attribute", "class"], ["value", "mvMoreColor"], ["selector", "img[title=\"More Colors Available\"]"], ["append_dont_overwrite", ""], ["multiple", "true"], ["to_parent", "true"], ["conditional_selector", ""], ["conditional_selector_is_relative", ""], ["use_value_from_parameter", ""], ["use_value_from_chain", ""]]
      var("done", "no")
      ...
      #[["image_selector", "img[title=\"More Colors Available\"]"], ["target_selector", ".mvMoreColor"], ["map_multiple", "true"]]
      var("counter", "a")
      $("//img[@title = \"More Colors Available\"]") {
        var("counter") {
          append("a")
      ...
      var("counter", "a")
      $("//*[contains(concat(' ', @class, ' '), ' mvMoreColor ')]") {
        var("counter") {
          append("a")
        }
      ...
      #
      #Content::Formatting::RemoveElements
      #[["selector", ".mvMoreColor > img"]]
      $("//*[contains(concat(' ', @class, ' '), ' mvMoreColor ')]/img") {
        remove()
      }
  ...
  #    #[["javascript_path", "http://d1topzp4nao5hp.cloudfront.net/sean_js_bundler/0.0.1/search-head.js "], ["add_after", "head > title"]]
  #    $("//head/title") {
  #      insert_after("script") {
  #        attribute("src", "http://d1topzp4nao5hp.cloudfront.net/sean_js_bundler/0.0.1/search-head.js ")
  #        attribute("language", "javascript")
  #      }
  #    }
  #    
  ...
  #    #
  #    #Content::Javascript::AddScriptTag
  #    #[["javascript_path", "http://d1topzp4nao5hp.cloudfront.net/sean_js_bundler/0.0.1/search-body.js "], ["add_after", "body > div:first-of-type"]]
  #    $("//body/div[position() = 1]") {
  #      insert_after("script") {
  #        attribute("src", "http://d1topzp4nao5hp.cloudfront.net/sean_js_bundler/0.0.1/search-body.js ")
  #        attribute("language", "javascript")
  #      }
  #    }
  #    
