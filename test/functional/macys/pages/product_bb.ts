...
html() {
  ...
  # No need to wrap the contents at all
    #Add Uranium JS
    #TODO: Add just the one uranium file after debugging
    #Group::BasicGroup
    #[]
    # No need to wrap the contents at all
      #
      #Content::Javascript::AddScriptTag
      # DON'T NEED THIS SINCE WE HAVE YUPUURANIUM-PRETTY, WHICH CONTAINS EVERYTHING
      #[["javascript_path", "http://dl.dropbox.com/u/3940085/moovweb/clients/macys-contract/js/uranium-pretty.js"], ["add_after", ""]]
  ...
  # No need to wrap the contents at all
    ...
    # No need to wrap the contents at all
      ...
      #
      #Content::Formatting::RemoveElements
      #[["selector", ".mvVendorContentWidget > p, #vendorContentWidget > p:last-of-type"]]
      $("//*[contains(concat(' ', @class, ' '), ' mvVendorContentWidget ')]/p") {
        remove()
      }
      $("//*[@id = 'vendorContentWidget']/p[position() = last()]") {
        remove()
      }
    ...
    #[["selector", ".mvProductDetailsTitle + div.productDetailLong"], ["html", "<span class=\"mvProMoreInfo\"><span class=\"mvPlus\">more </span><span class=\"mvMinus\">close </span></span>"], ["prepend", ""], ["append", "true"]]
    $("//*[contains(concat(' ', @class, ' '), ' mvProductDetailsTitle ')]/following-sibling::*[1]/self::div[contains(concat(' ', @class, ' '), ' productDetailLong ')]") {
      inner() {
        append("<span class=\"mvProMoreInfo\"><span class=\"mvPlus\">more </span><span class=\"mvMinus\">close </span></span>")
      }
    }
    ...
    #
    #Content::Formatting::Dynamic::Accordian3
    #[["link_selector", ".mvProMoreInfo"], ["content_selector", ".mvProductDetailsTitle + div.productDetailLong > ul.prodInfoList, .mvVendorContentWidget"], ["open_on_load", ""], ["hide_with_zero_height", ""]]
    var("counter", "")
    var("content_id_string", "[")
    ...
    $("//*[contains(concat(' ', @class, ' '), ' mvVendorContentWidget ')]") {
        attribute("class") {
          value() {
            append(" mw_accordian_hide")
          }
    ...
    var("counter", "")
    $("//*[contains(concat(' ', @class, ' '), ' mvProMoreInfo ')]") {
      var("counter") {
        append("a")
      }
      var("id", fetch("./@id"))
  ...
  # No need to wrap the contents at all
    ...
    #
    #Content::Formatting::AddAttribute
    #[["attribute", "class"], ["value", "mvOffterItemsWrapper"], ["selector", ".mvOfferAccordian .tabContent > div > div"], ["append_dont_overwrite", ""], ["multiple", "true"], ["to_parent", ""], ["conditional_selector", ""], ["conditional_selector_is_relative", ""], ["use_value_from_parameter", ""], ["use_value_from_chain", ""]]
    var("done", "no")
    $("//*[contains(concat(' ', @class, ' '), ' mvOfferAccordian ')]//*[contains(concat(' ', @class, ' '), ' tabContent ')]/div/div") {
      match($done, "no") {
        attribute("class") {
          value() {
              set("mvOffterItemsWrapper")
          }
        }
      }
    }
    ...
    #
    #Content::Formatting::MoveToBeginningOf
    #[["move_me", ".mvOffterItemsWrapper .productThumb.productThumbBorder"], ["to_beginning_of_me", ".mvOffterItemsWrapper"], ["map_multiple", "true"], ["ancestor_selector", ""]]
    var("counter", "a")
    $("//*[contains(concat(' ', @class, ' '), ' mvOffterItemsWrapper ')]") {
      var("counter") {
        append("a")
      }
      attribute("id2417", $counter)
    }
    var("counter", "a")
    $("//*[contains(concat(' ', @class, ' '), ' mvOffterItemsWrapper ')]//*[contains(concat(' ', @class, ' '), ' productThumb ') and contains(concat(' ', @class, ' '), ' productThumbBorder ')]") {
      var("counter") {
        append("a")
      }
      var("xpath") {
    ...
    #
    #Content::Formatting::MoveAfter
    #[["move_me", ".mvOffterItemsWrapper a.productThumbBonusDesc"], ["after_me", ".mvOffterItemsWrapper .productThumb.productThumbBorder"], ["map_multiple", "true"]]
    var("counter", "a")
    $("//*[contains(concat(' ', @class, ' '), ' mvOffterItemsWrapper ')]//*[contains(concat(' ', @class, ' '), ' productThumb ') and contains(concat(' ', @class, ' '), ' productThumbBorder ')]") {
      var("counter") {
        append("a")
      }
      attribute("id2432", $counter)
    }
    var("counter", "a")
    $("//*[contains(concat(' ', @class, ' '), ' mvOffterItemsWrapper ')]//a[contains(concat(' ', @class, ' '), ' productThumbBonusDesc ')]") {
      var("counter") {
        append("a")
      }
      var("xpath") {
    ...
    #
    #Content::Formatting::MoveAfter
    #[["move_me", ".mvOffterItemsWrapper a.standard"], ["after_me", ".mvOffterItemsWrapper a.productThumbBonusDesc"], ["map_multiple", "true"]]
    var("counter", "a")
    $("//*[contains(concat(' ', @class, ' '), ' mvOffterItemsWrapper ')]//a[contains(concat(' ', @class, ' '), ' productThumbBonusDesc ')]") {
      var("counter") {
        append("a")
      }
      attribute("id6608", $counter)
    }
    var("counter", "a")
    $("//*[contains(concat(' ', @class, ' '), ' mvOffterItemsWrapper ')]//a[contains(concat(' ', @class, ' '), ' standard ')]") {
      var("counter") {
        append("a")
      }
      var("xpath") {
    ...
    #[["selector", ".mvOffterItemsWrapper a.productThumbBonusDesc"], ["wrapper_class", "mvOffterDesc"], ["sibling_count", "1"]]
    $("//*[contains(concat(' ', @class, ' '), ' mvOffterItemsWrapper ')]//a[contains(concat(' ', @class, ' '), ' productThumbBonusDesc ')]") {
      wrap("div") {
        attribute("class", "mvOffterDesc")
    ...
    #
    #Content::Formatting::RemoveAttribute
    #[["attribute", "align"], ["selector", ".mvOffterItemsWrapper *"]]
    $("//*[contains(concat(' ', @class, ' '), ' mvOffterItemsWrapper ')]//*") {
      attribute("align") {
        remove()
      }
  ...
  match($element_exists, "false") {
    ...
    #
    #Content::Formatting::AddAttribute
    #[["attribute", "id"], ["value", "mvProductMember"], ["selector", "body"], ["append_dont_overwrite", ""], ["multiple", ""], ["to_parent", ""], ["conditional_selector", ""], ["conditional_selector_is_relative", ""], ["use_value_from_parameter", ""], ["use_value_from_chain", ""]]
    var("done", "no")
    $("//body") {
      match($done, "no") {
          var("done", "yes")
  ...
  $("(//*[@id = 'masterTableContainer'])[1]") {
    ...
    #
    #Content::Formatting::WrapWithNextSibling
    #[["selector", "#masterTable > script"], ["wrapper_class", "mvMasterItemWrapper"], ["sibling_count", "4"]]
    $("//*[@id = 'masterTable']/script") {
      wrap("div") {
    ...
    $("(//*[contains(concat(' ', @class, ' '), ' pdpMasterGroupingHeader ')])[1]") {
      ...
      #Body ID for MasterGroupingHeader
      #Content::Formatting::AddAttribute
      #[["attribute", "id"], ["value", "mvMasterGroupingHeaderBody"], ["selector", "body"], ["append_dont_overwrite", "true"], ["multiple", ""], ["to_parent", ""], ["conditional_selector", ".pdpMasterGroupingHeader"], ["conditional_selector_is_relative", ""], ["use_value_from_parameter", ""], ["use_value_from_chain", ""]]
      var("done", "no")
      $("//body") {
        match($done, "no") {
            var("conditional", "false")
          ...
          attribute("id") {
            value() {
                append(" mvMasterGroupingHeaderBody")
            }
          }
            }
        }
      ...
      #
      #Content::Inject::InjectHTML
      #[["html", "<br>"], ["add_after", ""], ["multiple", "true"], ["add_before", "#masterTable .mvDarkGrayBar"], ["conditional_selector", ""], ["negate_conditional_selector", ""]]
      $("//*[@id = 'masterTable']//*[contains(concat(' ', @class, ' '), ' mvDarkGrayBar ')]") {
        inject_before("<br>")
      }
    ...
    #[["attribute", "src"], ["value", "http://moovweb-gage.s3.amazonaws.com/yupu/macy2/macysBtns/noColorSelected.gif"], ["selector", ".mvMasterItemImg > .swatchBoxContainer > img[src*=\"spacer.gif\"]"]]
    ...
    # No need to wrap the contents at all
      #
      #Content::Formatting::MoveAfter
      #[["move_me", ".mvMasterItemWrapper .largeSwatch > div"], ["after_me", ".mvMasterItemWrapper .swatchBoxContainer > img"], ["map_multiple", "true"]]
      var("counter", "a")
      $("//*[contains(concat(' ', @class, ' '), ' mvMasterItemWrapper ')]//*[contains(concat(' ', @class, ' '), ' swatchBoxContainer ')]/img") {
        var("counter") {
          append("a")
        }
        attribute("id3781", $counter)
      }
      var("counter", "a")
      $("//*[contains(concat(' ', @class, ' '), ' mvMasterItemWrapper ')]//*[contains(concat(' ', @class, ' '), ' largeSwatch ')]/div") {
        var("counter") {
          append("a")
        }
        var("xpath") {
      ...
      #
      #Content::Formatting::RemoveElements
      #[["selector", ".mvMasterItemWrapper .largeSwatch"]]
      $("//*[contains(concat(' ', @class, ' '), ' mvMasterItemWrapper ')]//*[contains(concat(' ', @class, ' '), ' largeSwatch ')]") {
        remove()
      }
  ...
  $("(//*[contains(concat(' ', @class, ' '), ' coachfooter ')])[1]") {
    ...
    # No need to wrap the contents at all
      ...
      #
      #Content::Formatting::AddAttribute
      #[["attribute", "class"], ["value", "mvDarkGrayBar"], ["selector", ".mvCoachNav > a"], ["append_dont_overwrite", "true"], ["multiple", "true"], ["to_parent", ""], ["conditional_selector", ""], ["conditional_selector_is_relative", ""], ["use_value_from_parameter", ""], ["use_value_from_chain", ""]]
      var("done", "no")
    ...
    # No need to wrap the contents at all
      #
      #Content::Formatting::WrapElement
      #[["selector", ".mvCoachNav > a"], ["class_name", "mvCoachNavContent"], ["id", ""], ["add_elem_counter", ""], ["elem_count_offset", ""], ["empty_message", ""], ["relative_selector", ""], ["only_include_direct_children", ""]]
      var("found", "false")
      match($found, "false") {
        $("(//*[contains(concat(' ', @class, ' '), ' mvCoachNav ')]/a)[1]") {
          var("found", "true")
          insert_before("div") {
            attribute("the_wrapper", "true")
            attribute("class", "mvCoachNavContent")
            move_here("//*[contains(concat(' ', @class, ' '), ' mvCoachNav ')]/a[not (@the_wrapper)]", "bottom")
            attribute("the_wrapper") {
              remove()
            }
          }
    ...
    #move title before img
    #Content::Formatting::MoveBefore
    #[["move_me", ".coachproductname"], ["before_me", "#catalog_pdp_prod_image"], ["map_moves", ""]]
    $("(//*[@id = 'catalog_pdp_prod_image'])[1]") {
      move_here("(//*[contains(concat(' ', @class, ' '), ' coachproductname ')])[1]", "before")
    }
    ...
    #
    #Content::Formatting::MoveBefore
    #[["move_me", ".mvErrorText"], ["before_me", "#productAttributeDropdown"], ["map_moves", ""]]
    $("(//*[@id = 'productAttributeDropdown'])[1]") {
      move_here("(//*[contains(concat(' ', @class, ' '), ' mvErrorText ')])[1]", "before")
    }
  ...
  # No need to wrap the contents at all
    ...
    #
    #Content::Formatting::RemoveAttribute
    #[["attribute", "width"], ["selector", "img[alt=\"my macys\"]"]]
    $("//img[@alt = \"my macys\"]") {
      attribute("width") {
        remove()
      }
    ...
    #
    #Content::Formatting::RemoveAttribute
    #[["attribute", "Height"], ["selector", "img[alt=\"my macys\"]"]]
    $("//img[@alt = \"my macys\"]") {
      attribute("Height") {
        remove()
      }
