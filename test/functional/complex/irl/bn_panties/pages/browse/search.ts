...
$("body") {
  ...
  $("form") {
    ...
    $("div[@id='mainContainer']/div[@class='mainContentContainer']") {
      ...
      $("./div[@id='contentContainer2']") {
        ...
        $("./span[contains(@class,'searchBreadCrumbText')]") {
          wrap_text_children("div", class: "mw_txtWidget", data-ur-id:"refineWidget", data-ur-toggler-component:"content", data-ur-state:"enabled")
          $("./div | *[2]") {
            remove()
          }
          $("./a/text()") {          
            wrap("div", class: "mw_txtWidget", data-ur-id:"refineWidget", data-ur-toggler-component:"content", data-ur-state:"enabled")
          }
          $("./b") {          
            wrap("div", class: "mw_txtWidget", data-ur-id:"refineWidget", data-ur-toggler-component:"content", data-ur-state:"enabled")
          }
    ...
    $("//div[@class='resultsHeader'][not(node())]") {
      remove()
    }
  } # End of Form
} # End of Body