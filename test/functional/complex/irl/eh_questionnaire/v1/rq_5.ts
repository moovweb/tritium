...
html() {
  ...
  #[["attribute", "class"], ["value", "mRQ_5"], ["selector", ".mRQ"], ["append_dont_overwrite", "true"], ["multiple", ""], ["to_parent", ""], ["conditional_selector", ""], ["conditional_selector_is_relative", ""], ["use_value_from_parameter", ""], ["use_value_from_chain", ""]]
  var("done", "no")
  ...
  #
  #Content::Inject::InjectHTML
  #[["html", "<li class=\"formRad_1a  mRQFormQuestionsListItem\"><div class=\"question mRQFormQuestionsListItemQuestion\">Please answer the questions below.</div></li>"], ["add_after", ""], ["multiple", ""], ["add_before", ".mRQFormQuestionsListBattery .mRQFormQuestionsListItem:first-of-type"], ["conditional_selector", ""], ["negate_conditional_selector", ""]]
  $("(//*[contains(concat(' ', @class, ' '), ' mRQFormQuestionsListBattery ')]//*[contains(concat(' ', @class, ' '), ' mRQFormQuestionsListItem ') and position() = 1])[1]") {
    inject_before("<li class=\"formRad_1a  mRQFormQuestionsListItem\"><div class=\"question mRQFormQuestionsListItemQuestion\">Please answer the questions below.</div></li>")
  }
