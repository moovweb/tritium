...
html() {
  ...
  #[["attribute", "class"], ["value", "mRQ_4"], ["selector", "body"], ["append_dont_overwrite", "true"], ["multiple", ""], ["to_parent", ""], ["conditional_selector", ""], ["conditional_selector_is_relative", ""], ["use_value_from_parameter", ""], ["use_value_from_chain", ""]]
  var("done", "no")
  $("(//body)[1]") {
    match($done, "no") {
        var("done", "yes")
  ...
  # No need to wrap the contents at all
    ...
    #  #[["attribute", "class"], ["selector", ".mRQFormQuestionsListItemAnswerSliderSteps"]]
    #  $("//*[contains(concat(' ', @class, ' '), ' mRQFormQuestionsListItemAnswerSliderSteps ')]") {
    #    attribute("class") {
    #      remove()
    #    }
    #  }
    ...
    #  #[["move_me", ".mRQFormQuestionsListItemAnswerSliderSteps"], ["to_beginning_of_me", ".mRQFormQuestionsListItemAnswerSliderRow"], ["map_multiple", ""], ["ancestor_selector", ""]]
    #  $("(//*[contains(concat(' ', @class, ' '), ' mRQFormQuestionsListItemAnswerSliderRow ')])[1]") {
    #    move_here("(//*[contains(concat(' ', @class, ' '), ' mRQFormQuestionsListItemAnswerSliderSteps ')])[1]", "top")
    #  }
    #  
    #  
    #  #
    #  #Content::Formatting::RemoveAttribute
    #  #[["attribute", "class"], ["selector", ".mRQFormQuestionsListItemAnswerSlider"]]
  ...
  # No need to wrap the contents at all
    ...
    #
    #Content::Formatting::RemoveElements
    #[["selector", ".mRQFormContinueInput:not(:last-child)"]]
    $("//*[contains(concat(' ', @class, ' '), ' mRQFormContinueInput ') and not (position() = last())]") {
      remove()
    }
