...
html() {
  ...
  #your password link has exprired section on the reset password page
  $(".//div[@id='bd']") {
    $(".//div[@id='globalContentContainer']") {
      $(".//div[@id='ResetContainer']") {
        $("./div[@id='Resetheader']/h1") {
          add_class("mw_red_header")
          $("./img") {
            remove()
          }
          inject_bottom("your password link has expired")
        }
      }
    }
  }
