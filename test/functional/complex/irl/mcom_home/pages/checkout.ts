...
html() {
  ...
  match($fake_url, not(/\/shippingFees/)){
  ...
  match($element_exists, "false") {
    ...
    $("//html/body") {
      ...
      #        attribute("href","/bag/index.ognc")
      #      }
     # attribute("onload", "")
      # inject_top("<input type='submit' />")
    ...
    $("(//*[@id = 'billingAddress'])[1]") {
       $(".//div[@class='Shopping_Bag_promoCode_link']/a"){
    ...
    $("//*[@id = 'promoToRemove']/..") {
      add_class("mvPromoteWrap")
      $(".//span[@class='promoCode_content']"){
        name("div")
        $("br"){
          remove()
        }
    ...
    $("(//*[@id = 'checkoutSummary'])[1]") {
      ...
      #edit shipping method
        $("(//*[contains(concat(' ', @class, ' '), ' checkoutContainer ') and contains(concat(' ', @class, ' '), ' shipMeth ')]/h2)[1]") {
           wrap("div") {
              ...
              move_here("(following-sibling::a)[1]", "bottom")
            }
        }
        ...
        #back to bag
        $("(//h2[contains(concat(' ', @class, ' '), ' withSubText ') and contains(., \"merchandise\")])[1]") {    wrap("div") {
                attribute("class", "mvDarkGrayBar")
                move_here("(following-sibling::a)[1]", "bottom")
              }
          }
      ...
      # No need to wrap the contents at all
        ...
        $("//form[@name ='ordeReviewForm']") {
          $("div/div[contains(@class,'BillInfo')]"){
            $("div[2]/br"){
              remove()
            }
          }
