...
html() {
  ...
  $("(//input[@name = \"KEYWORD_GO_BUTTON\"])[1]") {
    ...
    match($fake_url, not(/\/wedding\//)) {
      ...
      #[["selector", "#globalNav"], ["html", "<div class=\"globalNavigationBar\"><div><a href=\"/shop/womens?id=118\">Women</a></div><div><a href=\"/shop/womens?id=1\">Men</a></div><div><a href=\"/shop/womens?id=22672\">Home</a></div><div><a href=\"/shop/womens?id=13247\">Shoes</a></div><div><a href=\"/shop/womens?id=16904\">Juniors</a></div><div><a href=\"/shop/womens?id=544\">Jewelry&nbsp;&amp;&nbsp;Watches</a></div><div><a href=\"/shop/handbags-accessories?id=26846\">Handbags</a></div><div><a href=\"/shop/womens?id=669\">Beauty</a></div><div><a href=\"/shop/womens?id=5991\">Kids</a></div><div><a href=\"/shop/womens?id=7495\">Bed&nbsp;&amp;&nbsp;Bath</a></div><div><a href=\"/shop/womens?id=29391\">Furniture</a></div><div><a href=\"/shop/womens?id=7497\">Kitchen</a></div><div><a href=\"/shop/womens?id=3536\">Sale</a></div></div>"], ["prepend", ""], ["append", ""]]
      $("//*[@id = 'globalNav']") {
        inner("<div class=\"globalNavigationBar\"><div><a href=\"/shop/womens?id=118\">Women</a></div><div><a href=\"/shop/womens?id=1\">Men</a></div><div><a href=\"/shop/womens?id=22672\">Home</a></div><div><a href=\"/shop/womens?id=13247\">Shoes</a></div><div><a href=\"/shop/womens?id=16904\">Juniors</a></div><div><a href=\"/shop/womens?id=544\">Jewelry&nbsp;&amp;&nbsp;Watches</a></div><div><a href=\"/shop/handbags-accessories?id=26846\">Handbags</a></div><div><a href=\"/shop/womens?id=669\">Beauty</a></div><div><a href=\"/shop/womens?id=5991\">Kids</a></div><div><a href=\"/shop/womens?id=7495\">Bed&nbsp;&amp;&nbsp;Bath</a></div><div><a href=\"/shop/womens?id=29391\">Furniture</a></div><div><a href=\"/shop/womens?id=7497\">Kitchen</a></div><div><a href=\"/shop/womens?id=3536\">Sale</a></div></div>")
      }
    ...
    match($fake_url, /\/wedding\//) {
      ...
      $("(//*[contains(concat(' ', @class, ' '), ' mvMore ')])[1]") {
        ...
        inject_after("<div class=\"mvDarkGrayBar mvRegistryHome\"><a class='sprite_me-arrow_right_white' href=\" /registry/wedding/registryhome?cm_sp=global_nav_reg-_-wedding_registry-_-n\" >Registry Home</a></div>")
      }
      ...
      #
      #Content::Formatting::AddAttribute
      #[["attribute", "class"], ["value", "mvDarkGrayBar"], ["selector", ".mvMenuOpener, .mvMenuWrapper > a"], ["append_dont_overwrite", "true"], ["multiple", "true"], ["to_parent", ""], ["conditional_selector", ""], ["conditional_selector_is_relative", ""], ["use_value_from_parameter", ""], ["use_value_from_chain", ""]]
      var("done", "no")
      $("//*[contains(concat(' ', @class, ' '), ' mvMenuOpener ')]") {
        match($done, "no") {
          attribute("class") {
  ...
  #
  #Content::Formatting::RemoveElements
  #[["selector", "#globalMastheadPool, .skip,#bd, #globalMastheadSocialLinks"]]
  ...
  #[["selector", "#hd"], ["class_name", "mvhd"], ["if_exists", ""]]
  $("(//*[@id = 'hd'])[1]") {
    attribute("class") {
      value() {
        append(" mvhd")
