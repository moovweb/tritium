...
func TestBlah(t *testing.T) {
	...
	p := MakeParser(string(a), wd, "scripts", "instructions.ts", false, false, make(map[string]bool), "")
	q := MakeParser(string(b), wd, "scripts", "instructions.ts", false, false, make(map[string]bool), "")
