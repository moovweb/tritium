...
# @guidelink http://console.moovweb.com/learn/docs/tools/xpath
...
" Returns the number of the current node in relation to other nodes Tritium has iterated through - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/index). @example `$(\"./div\") { log(index()) }` will return '1' if there is only one div child, '1 2' if there are two div children, and so on. "
...
# @guidelink http://console.moovweb.com/learn/tutorials/function_guides/index_func
@func Node.index() {
  index(this()) {
    yield()
  }
...
" Renames the current node to the tag specified by **%value** - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/rename). @example `name(\"span\")` will change the currently-selected node to a span. "
...
" Injects HTML (specified by **%html**) into the current node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/inject). @example `inject(\"<div>New Div</div>\")` will insert your new HTML into the current node. "
...
" Moves the currently-selected node to the node specified by **%xpath**, at the position **%pos** - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/moving). @example `move_to(\"//body\", \"top\")` will move the current node to the top of the body. "
# @hide
...
" Moves the currently-selected node to the bottom of the node specified by **%xpath** - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/moving). @example `move_to(\"//body\")` will move the current node to the bottom of the body."
...
" Moves the node specified by **%where** to the currently-selected node, at the position **%pos** - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/moving). @example `move_here(\"//table\", \"top\")` will move every table in the document into the top of the current node."
# @hide
...
" Moves the node specified by **%where** to the bottom of the currently-selected node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/moving). @example `move_here(\"//table\")` will move every table in the document into the bottom of the current node."
...
" Inserts a tag (specified by **%tag**) in the currently-selected node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/insert). @example `insert(\"div\")` will insert a div at the bottom of the current node."
# @hide
...
" Inserts a tag (specified by **%tag**) at the bottom of the currently-selected node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/insert). @example `insert_bottom(\"div\")` will insert a div at the bottom of the current node."
# @hide
...
" Inserts a tag (specified by **%tag**) at the top of the currently-selected node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/insert). @example `insert_top(\"div\")` will insert a div at the top of the current node."
# @hide
...
"Inserts a tag (specified by **%tag**) after the currently-selected node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/insert). @example `insert_after(\"div\")` will insert a div after the current node."
# @hide
...
" Inserts a tag (specified by **%tag**) before the currently-selected node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/insert). @example `insert_before(\"div\")` will insert a div before the current node."
# @hide
...
" Injects HTML (specified by **%html**) into the current node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/inject). @example `inject(read(\"file.html\"))` will inject the HTML in the specified file into the bottom of the current node."
# @hide
@func Node.inject(Text %html) {
  inject_at(position("bottom"), %html) {
    yield()
...
" Injects HTML (specified by **%html**) at the bottom of the current node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/inject). @example `inject_bottom(read(\"file.html\"))` will inject the HTML in the specified file into the bottom of the current node."
# @hide
...
" Injects HTML (specified by **%html**) at the top of the current node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/inject). @example `inject_top(read(\"file.html\"))` will inject the HTML in the specified file into the top of the current node."
# @hide
...
" Injects HTML (specified by **%html**) after the current node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/inject). @example `inject_after(read(\"file.html\"))` will inject the HTML in the specified file after the current node."
# @hide
...
" Injects HTML (specified by **%html**) before the current node - [click for example](http://console.moovweb.com/learn/tutorials/function_guides/inject). @example `inject_before(read(\"file.html\"))` will inject the HTML in the specified file before the current node."
# @hide
