...
html() {
  ...
  #[["attribute", "class"], ["value", "mRQ_16"], ["selector", ".mRQ"], ["append_dont_overwrite", "true"], ["multiple", ""], ["to_parent", ""], ["conditional_selector", ""], ["conditional_selector_is_relative", ""], ["use_value_from_parameter", ""], ["use_value_from_chain", ""]]
  var("done", "no")
  ...
  #[["attribute", "cols"], ["selector", ".mRQFormQuestionsListItemAnswer textarea"]]
  $("//*[contains(concat(' ', @class, ' '), ' mRQFormQuestionsListItemAnswer ')]//textarea") {
    attribute("cols") {
      remove()
    }
  }
  ...
  #
  #Content::Formatting::RemoveAttribute
  #[["attribute", "rows"], ["selector", ".mRQFormQuestionsListItemAnswer textarea"]]
  $("//*[contains(concat(' ', @class, ' '), ' mRQFormQuestionsListItemAnswer ')]//textarea") {
    attribute("rows") {
      remove()
    }
