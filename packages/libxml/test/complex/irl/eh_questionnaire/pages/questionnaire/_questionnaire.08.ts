$("/html/body/div/form[not(@id)]") {
  ...
  $mw_rq_slider_id = "mw_rq_8_21"
  $mw_rq_slider_question = "/html/body/corpse//form//table//table//table//tr[4]//table//tr[24]/td[1]/table//tr/td[2]/font/b"
  $mw_rq_slider_selection = "/html/body/corpse//form//table//table//table//tr[4]//table//tr[24]//input[@type='radio']"
  
  @import _slider.f.ts
  
  insert_bottom("div", fetch("/html/body/corpse//form//table//table//table//tr[6]//table//tr[1]/td/font/strong[contains(text(), '14.')]/text()"), class: "mw_rq_subsection_header") {
    text() {
      replace(/^\s*14\. /, "")
    }
  }
 
  $mw_rq_checkbox_id = "mw_rq_8_22"
  $mw_rq_checkbox_question = "/html/body/corpse//form//table//table//table//tr[6]//table//tr[1]/td/font/strong[contains(text(), '22.')]"
  $mw_rq_checkbox_selection = "/html/body/corpse//form//table//table//table//tr[6]//table//tr[3]/td/table//input | /html/body/corpse//form//table//table//table//tr[6]//table//tr[3]/td/table//strong/text()"
