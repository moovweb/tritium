...
html() {
  ...
  match($fake_url, /\/registry\/wedding\/registryhome/) {
    ...
    #Registry Home Page
        ...
        $("//*[@id = 'createButton']") {
          ...
          inner("")
          insert("img", src: asset('buttons/registry/create.png', 'image'))
        }
        ...
        $("//*[@id = 'createButton']") {
          ...
          attribute('src', asset('buttons/registry/create.png', 'image'))
        }
      ...
      # No need to wrap the contents at all
        ...
        $("//*[@id = 'cc2']//*[@id = 'updateButton']") {
          ...
          attribute('src', asset('buttons/registry/signin.png', 'image'))
        }
    ...
    # No need to wrap the contents at all
      ...
      $("//*[@id = 'cc21']//img") {
        ...
        attribute('src', asset('buttons/registry/update.png', 'image'))
      }
    ...
    $("(//*[@id = 'bd'])[1]") {
      ...
      insert_before("div", class: "mvRegistryHomeImg") {
        insert("img", src: asset('banners/Registry_HP-2.jpg', 'image'))
      }
    }
  ...
  match($fake_url, /registrycaptureemail/) {
    ...
    # No need to wrap the contents at all
      ...
      $("//*[@id = 'hasProfileSubmitImg']") {
        ...
        attribute('src', asset('buttons/registry/createRegistryBtn.png', 'image'))
      }
  ...
  match($fake_url, /(registrycreateaccount|registryeditaccount)/) {
    ...
    match($fake_url, /registrycreateaccount/) {
      ...
      $("//*[@id = 'submitImg']") {
        ...
        attribute('src', asset('buttons/registry/register.png', 'image'))
      }
    ...
    match($fake_url, /registryeditaccount/) {
      ...
      # No need to wrap the contents at all
        ...
        $("//*[contains(concat(' ', @class, ' '), ' mvPaneInnerWrapper ')]") {
          ...
          # On Update registry page, open accordian when the field is not completed.
            var("done", "no")
            $("div") {
              match($done, "no") {
                var("conditional", "false")
                $(".//label[contains(@class,'errorLabel')]") {
  ...
  match($fake_url, /registrysignin/) {
    ...
    # NOTE: just sets the attribute - doesn't do anything special for files
    # 11E: $("//img[@alt = \"Create\"]") {
    $("//a[@id='captureEmailLink' and text()='create']") {
      #attribute("src", "http://moovweb-gage.s3.amazonaws.com/yupu/macy2/macysBtns/createBtn.png")
      text("")
      insert("img", src: asset('buttons/create.png', 'image'))
    }
    
    $("//a[@id='captureEmailLink' and text()='access']") {
      text("")
      insert("img", src: asset('buttons/registry/accessRegistry.png', 'image'))
    }
  ...
  match($fake_url, /registrysearch/) {
    ...
    $("(//script[contains(@src, 'search-min.js')])[1]") {
      attribute("src", asset('search.js', 'js'))
    }
  ...
  match($fake_url, /registryclaim/) {
    ...
    $("//input[@alt = \"Access Registry\"]") {
      ...
      attribute('src', asset('buttons/registry/accessRegistry.png', 'image'))
    }
  ...
  match($fake_url, /(registrysignin|registrycaptureemail|registryclaimverify)/) {
    ...
    $("//*[@id = 'errorClose']") {
      #attribute("src", "https://moovweb-gage.s3.amazonaws.com/yupu/macys/account_btns/close_btn.gif")
      attribute('src', asset('buttons/close.png', 'image'))
    }
    ...
    $("//*[@id = 'innerConfirmSent']//*[@id = 'sentSubmit' and @alt = \"Sign In Again\"]") {
      ...
      attribute('src', asset('buttons/Sign-In-Again.png', 'image'))
    }
  ...
  # Add rewriter info so when the list gets sorted we can rewrite the links
  $("//body") {
    insert_top("div") {
  ...
  # Rewrite the XHR location for Forgot Password popup  
  $("//div[@id='registryContainer']/script") {
    text() {
      rewrite("link")
    }
  }
    ...
    # event details
    $("//h3[@id='eventDetails']/following-sibling::div[1]"){
      add_class("mvEventDetails")
    }
}
