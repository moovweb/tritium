html() {
  ...
  $("//body"){
      ...
      $(".//div[@id='profileContainer']"){
        ...
        $("form[@id='myWallet']"){
          ...
          $("div[@id='formButtonBgGrey']/input") {
            attribute('src', asset('buttons/save.png', 'image'))
          }
          $("input[@value='EDIT']"){
       ...
       # for my address
          $("form[@id='myaddress']"){
            ...
            $("div[@id='formButtonBgGrey']/input"){
              attribute('src', asset('buttons/addAddress.png', 'image'))
            }
            $("input[@value='UPDATE']"){
               $("../div[@id='formButtonBgGrey']/input"){
                  attribute('src', asset('buttons/updateAddress.png', 'image'))
                }
              $("./../div[@id='profileBorderShadow']/div[@id='profileListDisplay']"){
                add_class("mvHideElement")
              }
    ...
    $(".//br[@class='clearboth']|.//div[@id='vertSeperator']"){
      remove()
    }
  }
}
