...
$("body") {  
  ...
  $("form/div[@id='mainContainer']") {
    ...
    $("div[@class='mainContentContainer']/div[@id='contentArea']/div[@id='contentContainer2']") {
      ...
      $("div[@id='rightColumn2']/div[@class='moduleLogo']") {
        attribute("style") {
          remove()
        }
      }
      ...
      $("./div[@id='rightColumn2']") {
        ...
        $("div[@class='moduleLogo']") {
          ...
          move_to("./ancestor::div/div[@id='leftColumn2']")
        }
        ...
        $("div[ul]") {
          ...
          $("ul") {
            ...
            $("li[1]") {
              ...
              move_to("../../../../div[@id='leftColumn2']/div[@class='mainTitle']")
            }
            wrap("div") {
        ...
        $("//div[contains(@id, 'rightColumnActivePanel')]") {
          $(".//div[contains(@id, '_ProductCalloutPanel')]/div[@class='prodPriceCallout']") {
            ...
            move_to("../ancestor::div[@class='mainTitle']")
          }
